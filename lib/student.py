...
class ChattyStudent(Student):
    ...
    def raise_hand(self):
        return super().raise_hand(), super().raise_hand(), super().raise_hand(), super().raise_hand(), super().raise_hand(), super().raise_hand(), super().raise_hand(), super().raise_hand(), super().raise_hand(), super().raise_hand()
